...
class GeomDistEDMWithContrastiveLoss(BaseLoss):
    """
    EDM loss + contrastive margin loss (late-step focused).
    """

    name = "geomdist_edm_with_contrastive"
    ...
    def __call__(self, *, pred, target, sigma, observed_mask=None):
        ...
        for m in pred.keys():
            ...
            total_m = edm_loss + contrast_loss
